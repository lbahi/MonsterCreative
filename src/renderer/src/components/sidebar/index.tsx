...
import {
  ...
  Settings, Wand2, Copy, Crop, Monitor
} from 'lucide-react';
...
export const Sidebar = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', padding: '8px', paddingTop: 36 }}>
...
function ConnectionStatusPill({ status, onRefresh }: { status: string; onRefresh: () => void }) {
  const cfg = {
  ...
  }[status] || { color: 'rgba(255,255,255,0.2)', borderColor: 'var(--ma-border)', bg: 'transparent', text: 'Checking...', pulse: false };
