        ...
        <div style={{ marginBottom: 24 }}>
          ...
          >
            ...
            <span
              style={{
                ...
                color: isOutOfCredits ? '#EF4444' : isLowBalance ? 'var(--ma-amber)' : '#FFF'
              }}
            >
              {isRestricted
                ? '—'
          ...
          {isRestricted && (
            ...
            >
              <AlertTriangle
                size={13}
                style={{ color: 'var(--ma-amber)', flexShrink: 0, marginTop: 2 }}
              />
              <p style={{ fontSize: 11, color: 'var(--ma-amber)', margin: 0, lineHeight: 1.4 }}>
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    ;(window as any).api.external.open('https://fal.ai/dashboard/billing')
                  }}
          ...
          {(isLowBalance || isOutOfCredits) && (
            ...
            >
              <AlertTriangle
                size={14}
                style={{
                  color: isOutOfCredits ? '#EF4444' : 'var(--ma-amber)',
                  flexShrink: 0,
                  marginTop: 2
                }}
              />
              ...
              >
                {isOutOfCredits
                  ? 'Your fal.ai account is out of credits. Generations will fail.'
                  : 'Low credit balance. Top up soon to prevent generation interruptions.'}
              </p>
            </div>
          )}
        </div>
              ...
              return (
                <div key={row.model} style={{ marginBottom: 14 }}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: 11, fontFamily: 'var(--font-mono)', color: '#FFF' }}>
                      ${row.cost.toFixed(3)}
                    </span>
                  </div>
                  <div
