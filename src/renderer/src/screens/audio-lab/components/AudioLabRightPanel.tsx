    ...
    >
      ...
      <div style={{ padding: '24px 24px 16px', borderBottom: '1px solid var(--ma-border)' }}>
        ...
        >
          ...
          <span
            style={{ fontSize: 14, fontWeight: 700, color: '#FFF', fontFamily: 'var(--font-mono)' }}
          >
            ${estimatedCost}
          </span>
        </div>
      ...
      <div style={{ padding: '16px 24px 8px' }}>
        <h3 style={{ fontSize: 14, fontWeight: 600, color: '#FFF', margin: '0 0 4px' }}>
          Recent Results
        </h3>
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', margin: 0 }}>
          Your generated voiceovers
        </p>
      </div>
            ...
            >
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--ma-accent)' }}>
                    {result.voice}
                  </span>
                  <span
                    style={{
              ...
              <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
                <button
                  onClick={() =>
                    (window as any).api.utils.downloadFile({
                      url: result.url,
                      filename: `voiceover-${result.id}.mp3`
                    })
                  }
                  style={{
                    flex: 1,
