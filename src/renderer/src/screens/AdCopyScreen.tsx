...
import { ApiCostsRightPanel } from './ApiCostsScreen'; // Assuming this exists or similar
...
// --- API Costs Right Panel for Ad Copy ---
function AdCopyRightPanel({ currentModelLabel }: { currentModelLabel: string }) {
  ...
  return (
    <div style={{ padding: '24px 20px', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid var(--ma-border)', borderRadius: 12, padding: 16, marginBottom: 16 }}>
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8, marginTop: 0 }}>Strategy Engine</p>
      ...
      <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid var(--ma-border)', borderRadius: 12, padding: 16 }}>
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8, marginTop: 0 }}>API Balance</p>
        <div style={{ fontSize: 24, fontWeight: 700, color: 'var(--ma-green)', letterSpacing: -0.5 }}>
