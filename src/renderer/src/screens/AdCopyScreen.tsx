...
const ANALYSIS_MODELS = [
  {
    ...
    description: 'Fast & smart — ideal for most products.'
  },
  {
    id: 'google/gemini-2.5-pro',
    label: 'Gemini 2.5 Pro',
    description: 'Deepest analysis — for complex products.'
  },
  {
    id: 'anthropic/claude-3-5-sonnet',
    label: 'Claude 3.5 Sonnet',
    description: 'Top-tier linguistic creativity.'
  },
...
export function AdCopyScreen() {
  ...
  const selectedModelLabel =
    ANALYSIS_MODELS.find((m) => m.id === adCopy.analysisModel)?.label ?? adCopy.analysisModel
