...
export function ModelTypeSelector({ modelTemplates, selectedModelType, onSelect }: ModelTypeSelectorProps) {
  return (
    <div>
          ...
          return (
            ...
            >
              ...
              <div style={{
                ...
                padding: '24px 6px 8px', textAlign: 'center',
              }}>
                <div style={{ fontSize: 10, fontWeight: 700, color: isSelected ? tmpl.color : '#FFF', letterSpacing: '0.5px' }}>
                  {tmpl.label}
                </div>
