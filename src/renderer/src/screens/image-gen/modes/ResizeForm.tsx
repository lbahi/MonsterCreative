...
function LogoInstagram(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none">
      <defs>
...
function LogoTikTok(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none">
...
function LogoFacebook(): JSX.Element {
  return (
...
function LogoGoogle(): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none">
      <path
...
function LogoPinterest(): JSX.Element {
  return (
...
function LogoTwitter(): JSX.Element {
  return (
...
function LogoWooCommerce(): JSX.Element {
  return (
...
/* ─── Ratio preview box ───────────────────────────────────────────────────── */
function RatioBox({ w, h }: { w: number; h: number }): JSX.Element {
  const maxW = 22
  const maxH = 28
  const ratio = w / h
...
function NumBadge({ n }: { n: number }): JSX.Element {
  return (
    <div
      style={{
        width: 20,
