    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <img
              src={`./OutputSocialAds/${previewTemplate.id}.thumb.webp`}
          ...
          >
            ...
            <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', margin: 0, lineHeight: 1.6 }}>
              ...
              <span style={{ color: '#F59E0B' }}>
                This is a poster design that should be engaging for social media, showing some of
                the best features of the product with high energy. Aspect ratio: {selectedRatio}.
