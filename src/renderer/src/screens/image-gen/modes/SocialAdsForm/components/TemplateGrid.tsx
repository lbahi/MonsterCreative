    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          >
            <Sparkles size={14} color="var(--ma-accent)" />6 · Select Template
          </h3>
        ...
        {categories.map((cat) => (
          <button
            ...
            style={{
              ...
              background:
                selectedCategoryFilter === cat ? 'rgba(108,99,255,0.1)' : 'rgba(255,255,255,0.02)',
      ...
      >
        {filteredTemplates.map((t) => {
          ...
          const catColors: Record<string, string> = {
            ...
            Fragrance: '#C084FC',
            Fashion: '#A78BFA',
            'Luxury Fashion': '#7C3AED',
            'Winter Fashion': '#6366F1',
            Textiles: '#818CF8',
            Jewelry: '#F59E0B',
            Footwear: '#F97316',
            'Home & Décor': '#8B5CF6',
            ...
            'Food & Condiments': '#34D399',
            'Fast Food': '#F97316',
            Beverage: '#14B8A6',
            'Fitness & Supplements': '#22D3EE',
            'Outdoor & Sports': '#06B6D4',
            Suncare: '#FBBF24',
            'Tech & Gadgets': '#3B82F6',
            'Tech & SaaS': '#2563EB',
            Gaming: '#EF4444',
            ...
            'Launch & Bold': '#DC2626',
            'Art & Print': '#D946EF',
            'Design & Events': '#C026D3',
            Universal: '#6B7280',
            General: '#6B7280',
            'Baby Products': '#FDA4AF'
          }
        ...
        >
          ...
          <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.5)', margin: 0, lineHeight: 1.55 }}>
            ...
            <span style={{ color: '#F59E0B' }}>
              This is a poster design that should be engaging for social media, showing some of the
              best features of the product with high energy. Aspect ratio: {selectedRatio}.
