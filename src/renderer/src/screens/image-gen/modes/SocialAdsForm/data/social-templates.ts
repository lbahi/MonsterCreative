...
export const SOCIAL_TEMPLATES = [
  {
    id: 't1',
    category: 'Outdoor',
    coverImage: './SocialAdsTemplates/t1.jpg',
    bestFor: 'Food & Health Supplements, Outdoor Gear, Sportswear',
    prompt:
      'Create an outdoor lifestyle product photography shot with a bright, fresh, adventurous feel. The image provided should be analyzed and used as a reference image. 85mm portrait lens look, shallow depth of field (f/2.8), sharp focus on The Provided Product, softly blurred background.'
  },
  {
    id: 't2',
    category: 'Home',
    coverImage: './SocialAdsTemplates/t2.jpg',
  ...
  },
  {
    id: 't3',
    category: 'Home',
    coverImage: './SocialAdsTemplates/t3.jpg',
  ...
  },
  {
    id: 't4',
    category: 'Furniture',
    coverImage: './SocialAdsTemplates/t4.jpg',
  ...
  },
  {
    id: 't7',
    category: 'Beauty',
    coverImage: './SocialAdsTemplates/t7.jpg',
  ...
  },
  {
    id: 't9',
    category: 'Beauty',
    coverImage: './SocialAdsTemplates/t9.jpg',
  ...
  },
  {
    id: 't10',
    category: 'Food',
    coverImage: './SocialAdsTemplates/t10.jpg',
  ...
  },
  {
    id: 't11',
    category: 'Food',
    coverImage: './SocialAdsTemplates/t11.jpg',
  ...
  },
  {
    id: 't14',
    category: 'Beauty',
    coverImage: './SocialAdsTemplates/t14.jpg',
  ...
  },
  {
    id: 't16',
    category: 'Universal',
    coverImage: './SocialAdsTemplates/t16.jpg',
  ...
  },
  {
    id: 't17',
    category: 'Food',
    coverImage: './SocialAdsTemplates/t17.jpg',
  ...
  },
  {
    id: 't18',
    category: 'Food',
    coverImage: './SocialAdsTemplates/t18.jpg',
  ...
  },
  {
    id: 't19',
    category: 'Food',
    coverImage: './SocialAdsTemplates/t19.jpg',
  ...
  },
  {
    id: 't21',
    category: 'Beauty',
    coverImage: './SocialAdsTemplates/t21.jpg',
  ...
  },
  {
    id: 't24',
    category: 'Fitness',
    coverImage: './SocialAdsTemplates/t24.jpg',
  ...
  },
  {
    id: 't25',
    category: 'Fitness',
    coverImage: './SocialAdsTemplates/t25.jpg',
  ...
  },
  {
    id: 't28',
    category: 'CGI',
    coverImage: './SocialAdsTemplates/t28.jpg',
  ...
  },
  {
    id: 't31',
    category: 'Tech',
    coverImage: './SocialAdsTemplates/t31.jpg',
  ...
  },
  {
    id: 't32',
    category: 'Fashion',
    coverImage: './SocialAdsTemplates/t32.jpg',
...

  {
    id: 't37',
    category: 'Tech',
    coverImage: './SocialAdsTemplates/t37.jpg',
  ...
  },
  {
    id: 't39',
    category: 'Fashion',
    coverImage: './SocialAdsTemplates/t39.jpg',
    bestFor: 'Food, Skincare, Fashion Accessories, Stationery, Lifestyle Products',
    prompt:
      'Create a top-down flat lay of The Provided Product on a clean studio surface. Balanced composition, soft even lighting, realistic material texture, minimal shadow, commercial product photography style. The image provided should be analyzed and used as a reference image to replicate the product accurately.'
  },
  {
    id: 't40',
    category: 'Universal',
    coverImage: './SocialAdsTemplates/t40.jpg',
  ...
  },
  {
    id: 't42',
    category: 'Outdoor',
    coverImage: './SocialAdsTemplates/t42.jpg',
  ...
  },
  {
    ...
    prompt:
      'Place The Provided Product in a realistic desk setup with complementary objects. Clean arrangement, soft window light, product as the clear focal point. Modern commercial photography. The image provided should be analyzed and used as a reference image to accurately reproduce the product.'
  },
  {
    id: 't45',
    category: 'Fashion',
    coverImage: './SocialAdsTemplates/t45.jpg',
    bestFor: 'E-commerce Catalogs, Fashion, Skincare, Electronics, Footwear',
    prompt:
      'Create a clean product composition showing The Provided Product from front, side, and slightly angled views in one frame. Consistent studio lighting, neutral background, preserve exact color and shape. Catalog-ready photography. The image provided should be analyzed and used as a reference image.'
  },
  {
    id: 't46',
    category: 'Food',
    coverImage: './SocialAdsTemplates/t46.jpg',
    bestFor: 'Packaging, Cosmetics, Food, Luxury Boxes, Candles',
    prompt:
      'Show The Provided Product in both closed and open state in one clean composition. Preserve exact design, color, and proportions. Soft studio lighting, neutral background, e-commerce detail photography. The image provided should be analyzed and used as a reference image.'
  },
  {
    id: 't48',
    category: 'Tech',
    ...
    prompt:
      'Show The Provided Product being held naturally in one hand to communicate scale. Realistic proportions, clean background, clear focus on the product, no distortion. E-commerce lifestyle photography. The image provided should be analyzed and used as a reference image to preserve exact product dimensions and design.'
  },
  {
    id: 't49',
    category: 'Fashion',
    coverImage: './SocialAdsTemplates/t49.jpg',
    bestFor: 'Skincare, Fashion, Fitness, Food & Beverage, Tech Wearables',
    prompt:
      'Show a model naturally using The Provided Product in a realistic setting. Keep the product clearly visible and in focus. Authentic lighting, modern lifestyle product photography. The image provided should be analyzed and used as a reference image to preserve exact product design and inform the scene.'
  },
  {
    id: 't50',
    category: 'Beauty',
    coverImage: './SocialAdsTemplates/t50.jpg',
    bestFor: 'Skincare, Nail Care, Jewelry, Luxury Beauty, Cosmetics',
    prompt:
      'Show elegant hands interacting with The Provided Product. No face visible, clean composition, soft studio lighting, sharp product focus. Premium beauty and skincare photography style. The image provided should be analyzed and used as a reference image.'
  },
  {
    id: 't51',
    category: 'Beauty',
    coverImage: './SocialAdsTemplates/t51.jpg',
    bestFor: 'Beauty, Skincare, Food & Beverage, Fashion, Any Seasonal Campaign',
    prompt:
      'Place The Provided Product in a fresh spring-themed scene. Light, airy styling, soft natural light, clean composition, subtle seasonal details such as blossoms or pastel tones. Preserve the exact product shape, branding, and details. The image provided should be analyzed and used as a reference image.'
  },
  {
    id: 't52',
    category: 'Fashion',
    coverImage: './SocialAdsTemplates/t52.jpg',
    bestFor: 'Beverages, Suncare, Fashion, Outdoor Products, FMCG',
    prompt:
      'Place The Provided Product in a bright summer setting. Warm natural light, fresh energetic atmosphere, clean composition, product clearly visible. Premium seasonal lifestyle photography. The image provided should be analyzed and used as a reference image.'
  },
  {
    id: 't53',
    category: 'Fashion',
    ...
    prompt:
      'Place The Provided Product in a crisp snowy winter setting. Bright, cold winter light, clean composition, subtle frost or snow atmosphere, preserve the exact product shape, branding, and details. The image provided should be analyzed and used as a reference image.'
  },
  {
    id: 't54',
    category: 'Universal',
  ...
  },
  {
    id: 't56',
    category: 'CGI',
    coverImage: './SocialAdsTemplates/t56.jpg',
  ...
  },
  {
    id: 't59',
    category: 'Food',
    coverImage: './SocialAdsTemplates/t59.jpg',
