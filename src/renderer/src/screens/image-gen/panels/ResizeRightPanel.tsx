    ...
    <div style={{ fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ padding: '20px 20px 16px', borderBottom: '1px solid var(--ma-border)' }}>
        ...
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', margin: '4px 0 0' }}>
          Engine: <span style={{ fontFamily: 'var(--font-mono)', color: 'rgba(255,255,255,0.5)' }}>{modelLabel}</span>
        </p>
      </div>
      ...
      {generating && (
        <div style={{ padding: '24px 20px' }}>
          ...
          <StepChecklist steps={IMG_STEPS} onComplete={() => {}} estimatedTime={`~${selectedFormats.length * 6}s`} />
      ...
      {!generating && !generated && (
        <div style={{ padding: 20 }}>
          ...
          {selectedPlatforms.length > 0 && (
            <div>
              <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: '0.8px', marginBottom: 8 }}>
                Queued Formats
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                {selectedPlatforms.map((fmt) => (
                  ...
                  >
                    <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.7)' }}>{fmt.label}</span>
